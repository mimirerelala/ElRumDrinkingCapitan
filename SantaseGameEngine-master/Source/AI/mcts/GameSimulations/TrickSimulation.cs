namespace Santase.AI.RumDrinkingCapitanPlayer.GameSimulations
{
    ...
    {
        private readonly RoundPlayerInfoSimulation firstToPlay;

        private readonly RoundPlayerInfoSimulation secondToPlay;
        ...
        public TrickSimulation(
            RoundPlayerInfoSimulation firstToPlay,
            RoundPlayerInfoSimulation secondToPlay,
        ...
        public RoundPlayerInfoSimulation Play()
        {
        ...
        private static PlayerAction GetPlayerAction(RoundPlayerInfoSimulation playerInfo, PlayerTurnContext context)
        {
        ...
        private PlayerAction GetFirstPlayerAction(RoundPlayerInfoSimulation playerInfo, PlayerTurnContext context)
        {
            while (true)
            {
